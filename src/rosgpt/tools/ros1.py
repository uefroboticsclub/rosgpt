...
def rosservice_list(
    ...
    :param exclude_rosgptapi: (optional) If True, exclude services related to the ROS API.
    ...
    if exclude_rosgptapi:
        services = list(filter(lambda x: not x.startswith("/rosgptapi"), services))
...
@tool
def rosparam_set(param: str, value: str, is_rosgpt_param: bool) -> str:
    """Sets the value of a specific ROS parameter.

    :param param: The name of the ROS parameter to set.
    :param value: The value to set the parameter to.
    :param is_rosgpt_param: If True, set the parameter in the ROSGPT namespace.
    """

    if is_rosgpt_param and not param.startswith("/rosgpt"):
        param = f"/rosgpt/{param}".replace("//", "/")
